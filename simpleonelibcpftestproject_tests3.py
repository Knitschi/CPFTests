...
class SimpleOneLibCPFTestProjectFixture3(simpleonelibcpftestprojectfixture.SimpleOneLibCPFTestProjectFixture):
    ...
    def setUp(self):
        super(SimpleOneLibCPFTestProjectFixture3, self).setUp(self.project, self.cpf_root_dir, self.cpf_cmake_dir, self.ci_buildconfigurations_dir, self.instantiating_module)
